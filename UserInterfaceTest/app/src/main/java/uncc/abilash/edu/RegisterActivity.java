...
public class RegisterActivity extends Activity implements MyMacros{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final EditText house = (EditText) findViewById(R.id.editText8);
        ...
        resetButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                usrName.setText("devendra");
                pwd.setText("xyz123");
                verifyPwd.setText("xyz123");
                firstName.setText("Devendra");
                lastName.setText("Bhangale");
                house.setText("");
                phone.setText("9803651211");
                eMail.setText("dbhangal@uncc.edu");
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String hse = house.getText().toString();
                ...
                else if (hse.length() == 0){
                    house.setError(getResources().getString(R.string.house_error_message));
                }
                ...
                //finally on successfull verification the appropriate message is displayed
                    ...
                    String status = getConnection(userName,password,first_Name, last_Name, hse,  mail, phone_No);
                    ...
                    else if(status.equals("false_house\n")){
                        Toast.makeText(getBaseContext(),"House name already exists. Please enter different house name!",Toast.LENGTH_SHORT).show();
                    }
                    else
    ...
    public String getConnection(String usr, String pwd, String fName, String lName, String house, String mail, String phone){

        InputStream inputStream = null;
        String result = "";
        ArrayList<NameValuePair> nameValuePairs1 = new ArrayList<NameValuePair>();
        nameValuePairs1.add(new BasicNameValuePair("uname",usr));
        nameValuePairs1.add(new BasicNameValuePair("pwd",pwd));
        nameValuePairs1.add(new BasicNameValuePair("firstname",fName));
        nameValuePairs1.add(new BasicNameValuePair("lastname",lName));
        nameValuePairs1.add(new BasicNameValuePair("house",house));
        ...
        try{
            ...
            HttpPost httppost = new HttpPost("http://"+HOME_IP_ADDRESS+"/register.php");
