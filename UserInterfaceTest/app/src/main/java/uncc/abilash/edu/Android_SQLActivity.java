...
public class Android_SQLActivity extends Activity implements MyMacros{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        login_button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(userString.equals("") ||pwdString.equals("")){
                    ...
                    String house = getConnection(userString);
        ...
        Reset.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                userName.setText("devendra");
                password.setText("xyz123");
            }
        });
    ...
    public String getConnection(String usr, String pwd){
        ...
        try{
            ...
            HttpPost httppost = new HttpPost("http://"+HOME_IP_ADDRESS+"/login.php");
    ...
    public String getConnection(String usr){
        ...
        try{
            ...
            // have to change the ip here to correct ip
            HttpPost httppost = new HttpPost("http://"+HOME_IP_ADDRESS+"/gethouse.php");
            httppost.setEntity(new UrlEncodedFormEntity(nameValuePairs1));
            HttpResponse response = httpclient.execute(httppost);
            HttpEntity entity = response.getEntity();
            inputStream = entity.getContent();
